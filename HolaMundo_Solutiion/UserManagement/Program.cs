namespace UserManagement
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                switch (selectedOption)
                {
                    case "1":
                        ...
                        var result = uRepo.SearchUser(searchValue);
            ...
            var matches = uRepoG.Search(u => u.NickName.ToLower().Contains("h") && u.Email.ToLower().Contains("h"));
            uRepoG.Search(SearchUser);

            matches = uRepoG.Search(u =>
            ...
            //uRepo.Delete(uRepoG.Search(u => u.ID == 1).First());
            ...
            uRepoG.Sort(y: 45, predicate: (u1, u2) =>
            {
